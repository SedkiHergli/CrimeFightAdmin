...
module.exports = "<ion-tabs>\n  <ion-tab-bar slot=\"bottom\">\n    <ion-tab-button tab=\"accountus\" href=\"/admin/(accountus:accountus)\">\n      <ion-icon name=\"person\"></ion-icon>\n      <ion-label>Users</ion-label>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"supervisors\"  href=\"/admin/(supervisors:supervisors)\" (click)=\"tab2Selected()\">\n      <ion-icon name=\"people\"></ion-icon>\n      <ion-label>Supervisors</ion-label>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"logout\" (click)=\"logout()\">\n      <ion-icon name=\"log-out\"></ion-icon>\n      <ion-label>Logout</ion-label>\n    </ion-tab-button>\n\n  </ion-tab-bar>\n\n  <ion-tab tab=\"accountus\">\n    <ion-router-outlet name=\"accountus\"></ion-router-outlet>\n  </ion-tab>\n\n  <ion-tab tab=\"supervisors\">\n    <ion-router-outlet name=\"supervisors\"></ion-router-outlet>\n  </ion-tab>\n\n  <ion-tab tab=\"maps\">\n    <ion-router-outlet name=\"maps\"></ion-router-outlet>\n  </ion-tab>\n  \n</ion-tabs>\n"
...
var AdminComponent = /** @class */ (function () {
    ...
    AdminComponent.prototype.tab2Selected = function () {
...
var routes = [
    ...
    { path: 'admin', loadChildren: './admin/admin.module#AdminModule', canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuardService"]] },
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, authService, router, navctrl) {
...
/* harmony import */ var _services_supervisor_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/supervisor.service */ "./src/app/services/supervisor.service.ts");
...
/* harmony import */ var _services_ionicgestureconfig_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./services/ionicgestureconfig.service */ "./src/app/services/ionicgestureconfig.service.ts");
/* harmony import */ var _services_emergency_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./services/emergency.service */ "./src/app/services/emergency.service.ts");
/* harmony import */ var _services_sensor_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/sensor.service */ "./src/app/services/sensor.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"],
                ...
                _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_18__["JwtModule"].forRoot({
                    jwtOptionsProvider: {
                        ...
                        deps: [_ionic_storage__WEBPACK_IMPORTED_MODULE_17__["Storage"]],
                    }
                }),
            ...
            providers: [
                ...
                _services_emergency_service__WEBPACK_IMPORTED_MODULE_20__["EmergencyService"],
                _services_sensor_service__WEBPACK_IMPORTED_MODULE_21__["SensorService"],
                _services_user_service__WEBPACK_IMPORTED_MODULE_14__["UserService"],
                _services_supervisor_service__WEBPACK_IMPORTED_MODULE_15__["SupervisorService"],
                { provide: _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicRouteStrategy"] },
                {
                    ...
                    useClass: _services_ionicgestureconfig_service__WEBPACK_IMPORTED_MODULE_19__["IonicGestureConfig"]
                },
            ],
...
module.exports = "* {\n  box-sizing: border-box; }\n\n.col-container {\n  display: table;\n  width: 100%; }\n\n.col {\n  display: table-cell;\n  padding: 16px;\n  margin: 5px;\n  width: 33%; }\n\n@media only screen and (max-width: 200px) {\n  .col {\n    display: block;\n    width: 100%; } }\n\n.col:hover {\n  background: #c71f1f77; }\n\np {\n  font-weight: bold; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _services_emergency_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../services/emergency.service */ "./src/app/services/emergency.service.ts");
/* harmony import */ var _services_sensor_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../services/sensor.service */ "./src/app/services/sensor.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AccountusPage = /** @class */ (function () {
    function AccountusPage(alertController, navContrl, locationService, authService, storage, network, toastCtrl, userService, supervisorService, emergencyService, sensorService) {
            ...
            this.storage.get("access_token").then(function (tokenn) {
                ...
                if (!_this.user) {
                    _this.storage.get("User").then(function (userr) {
                        _this.user = userr;
                        _this.getAllUser();
                        var source = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(60000);
    ...
    AccountusPage.prototype.getAllUser = function () {
        var _this = this;
        this.userService.getAllUser(this.token).subscribe(function (resp) {
            _this.userss = [];
    ...
    AccountusPage.prototype.goTouser = function (p) {
        this.storage.set('data', p);
        this.navContrl.navigateRoot('/admin/(maps:maps)');
    };
    AccountusPage.prototype.onPress = function ($event, p) {
        this.ChangeU(p);
    };
    AccountusPage.prototype.ChangeAccountU = function (user) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.userService.updateUser(_this.datan, user.email, _this.token).subscribe(function (res) {
                                            _this.locationService.updateLocation(_this.datan, user.email, _this.token).subscribe(function (res) {
                                                _this.emergencyService.updateEmergency(_this.datan, user.email, _this.token).subscribe(function (res) {
                                                    _this.sensorService.updateSensor(_this.datan, user.email, _this.token).subscribe(function (res) {
                                                        _this.supervisorService.updateSupervisor(datta, user.email_s, _this.token).subscribe(function (res) {
                                                            _this.getAllUser();
                                                        });
                                                    });
                                                });
    ...
    AccountusPage.prototype.ChangePasswordU = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        if (!data["password"] || data["cpassword"] != data["password"] || data["password"].length < 6) {
                                            ...
                                            _this.userService.updateUser(data, user.email, _this.token).subscribe(function (resp) { return _this.getAllUser(); });
                                        }
                                    }
                                }
                            ]
    ...
    AccountusPage.prototype.ChangeSupervisorU = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        if (!data["fullName"] || !data["email"] || !data["phone"] || !data["password"]) {
                                            ...
                                            _this.supervisorService.deleteSupervisor(user.email_s, _this.token).subscribe(function (res) {
                                                _this.authService.registerS(data).subscribe(function (res) {
                                                    _this.userService.updateUser(datta, user.email, _this.token).subscribe(function (res) {
                                                        _this.getAllUser();
                                                    });
                                                });
                                            });
    ...
    AccountusPage.prototype.ChangeU = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    text: 'Modify User',
                                    handler: function (data) {
                                        _this.ChangeAccountU(p);
                                    }
                                },
                                {
                                    text: 'Modify Password',
                                    handler: function (data) {
                                        _this.ChangePasswordU(p);
                                    }
                                },
                                {
                                    text: 'Change Supervisor',
                                    handler: function (data) {
                                        _this.ChangeSupervisorU(p);
                                    }
                                },
                                {
                                    text: 'Delete User',
    ...
    AccountusPage.prototype.showAlert = function (msg) {
    ...
    AccountusPage.prototype.deleteUser = function (user) {
        var _this = this;
        this.supervisorService.deleteSupervisor(user.email_s, this.token).subscribe(function (res) {
            _this.userService.deleteUser(user.email, _this.token).subscribe(function (res) {
                _this.sensorService.deleteSensor(user.email, _this.token).subscribe(function (res) {
                    _this.emergencyService.deleteEmergency(user.email, _this.token).subscribe(function (res) {
                        _this.locationService.deleteLocation(user.email, _this.token).subscribe(function (res) {
                            _this.getAllUser();
                        });
                    });
                });
    ...
    AccountusPage.prototype.initializee = function () {
    ...
    AccountusPage = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"],
            ...
            _services_supervisor_service__WEBPACK_IMPORTED_MODULE_8__["SupervisorService"],
            _services_emergency_service__WEBPACK_IMPORTED_MODULE_9__["EmergencyService"],
...
module.exports = "<ion-header>\n    <ion-toolbar style=\"--background: rgb(82, 96, 158);\">\n      <ion-buttons slot=\"start\">\n        <ion-back-button defaultHref=\"/admin/(accountus:accountus)\" [text]=\"buttonText\" [icon]=\"buttonIcon\"></ion-back-button>\n      </ion-buttons>\n      <ion-title>Map</ion-title>\n    </ion-toolbar>\n  </ion-header>\n   \n  <ion-content>\n    <ion-list  style=\"height: 10%;width: 100%;background: rgb(82, 96, 158,0.5);\" expand=\"full\">\n        <ion-grid expand=\"full\">\n            <ion-row expand=\"full\">\n              <ion-col >\n                {{sentData?.name_s}}\n              </ion-col>\n              <ion-col size=\"6\">\n                {{sentData?.email_s}}\n              </ion-col>\n              <ion-col>\n                {{sentData?.phone_s}}\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n    </ion-list>\n    \n    <div #map id=\"map\" style=\"height: 94%;width: 100%\"></div>\n\n   </ion-content>"
...
var MapsPage = /** @class */ (function () {
        ...
        if (!this.token) {
            this.storage.get("access_token").then(function (tokenn) {
                ...
                if (!_this.user) {
                    _this.storage.get("User").then(function (userr) {
                        _this.user = userr;
                        _this.ionViewDidLoad({ 'lat': Number(_this.sentData.lat), 'lng': Number(_this.sentData.lng) });
                    });
                }
            });
        }
    };
    MapsPage.prototype.addMarker = function (message) {
        var _this = this;
    ...
    MapsPage.prototype.ionViewDidLoad = function (pos) {
        var _this = this;
        this.plt.ready().then(function () {
            ...
            _this.addMarker(_this.sentData.fullName);
    ...
    MapsPage = __decorate([
        ...
        __metadata("design:paramtypes", [_services_location_service__WEBPACK_IMPORTED_MODULE_4__["LocationService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_supervisor_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/supervisor.service */ "./src/app/services/supervisor.service.ts");
...
var WeathersPage = /** @class */ (function () {
    function WeathersPage(supervisorService, userService, storage, alertController) {
        this.supervisorService = supervisorService;
        this.userService = userService;
        this.storage = storage;
        this.alertController = alertController;
    ...
    WeathersPage.prototype.ngOnInit = function () {
        ...
        this.storage.get("access_token").then(function (tokenn) {
            _this.token = tokenn;
            if (_this.token) {
                _this.getAllSupervisor();
                var source = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(60000);
                _this.subscriptionnn = source.subscribe(function (val) {
                    _this.getAllSupervisor();
                });
            }
        });
    };
    WeathersPage.prototype.ngOnDestroy = function () {
        this.subscriptionnn.unsubscribe();
    };
    WeathersPage.prototype.getAllSupervisor = function () {
        var _this = this;
        this.supervisorService.getAllSupervisor(this.token).subscribe(function (resp) {
            _this.userss = [];
            for (var _i = 0, resp_1 = resp; _i < resp_1.length; _i++) {
                var i = resp_1[_i];
                if (i.stype != "Admin")
    ...
    WeathersPage.prototype.onPress = function ($event, p) {
        this.ChangeU(p);
    };
    WeathersPage.prototype.ChangeU = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    text: 'Modify User',
                                    handler: function (data) {
                                        _this.ChangeAccountS(p);
                                    }
                                },
                                {
                                    text: 'Modify Password',
                                    handler: function (data) {
                                        _this.ChangePasswordS(p);
                                    }
                                },
                                {
                                    text: 'CANCEL',
    ...
    WeathersPage.prototype.showAlert = function (msg) {
        var alert = this.alertController.create({
            message: msg,
            header: 'Error',
            buttons: ['OK']
    ...
    WeathersPage.prototype.ChangeAccountS = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.userService.updateUser(datta, user.email_u, _this.token).subscribe(function (res) {
                                            _this.supervisorService.updateSupervisor(_this.datan, user.email, _this.token).subscribe(function (resp) { return _this.getAllSupervisor(); });
                                        });
                                    }
                                }
                            ]
    ...
    WeathersPage.prototype.ChangePasswordS = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        if (!data["password"] || data["cpassword"] != data["password"] || data["password"].length < 6) {
                                            ...
                                            _this.supervisorService.updateSupervisor(data, user.email, _this.token).subscribe(function (resp) { return _this.getAllSupervisor(); });
                                        }
                                    }
                                }
                            ]
    ...
    WeathersPage = __decorate([
        ...
        __metadata("design:paramtypes", [_services_supervisor_service__WEBPACK_IMPORTED_MODULE_1__["SupervisorService"],
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.revokeIssuedRefreshTokens = function (tokenn) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + tokenn
        ...
        return this.http.post(this.url + "/auth/revokeIssuedRefreshTokens", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (e) {
            throw new Error(e);
        }));
    };
    //register Supervisor
...
/***/ "./src/app/services/ionicgestureconfig.service.ts":
/*!********************************************************!*\
  !*** ./src/app/services/ionicgestureconfig.service.ts ***!
  \********************************************************/
...
var SupervisorService = /** @class */ (function () {
    ...
    SupervisorService.prototype.getAllSupervisor = function (token) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + token
        ...
        return this.http.get(this.authService.url + "/supers", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (e) {
            throw new Error(e);
        }));
    };
    //show alert
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getAllUser = function (token) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + token
        ...
        return this.http.get(this.authService.url + "/users", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (e) {
            throw new Error(e);
        }));
    };
...
module.exports = __webpack_require__(/*! C:\Users\dell\Desktop\projectka3\SmartCareAdmin\src\main.ts */"./src/main.ts");
